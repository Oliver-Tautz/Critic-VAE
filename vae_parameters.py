...
CRAFTER_CRITIC_PATH_REAL = f"crafter_models/critic-batch_size=32-dataset_size=45000-epochs=50/critic.pt"
CRAFTER_CRITIC_PATH = f"crafter_models/critic-batch_size=32-dataset_size=45000-epochs=50_real/critic.pt"
